...
--  to output movies with an odd numbered ID and a description that is not 'boring'.
...
-- Runtime: 188 ms, faster than 70.13% of MySQL online submissions for Not Boring Movies.
