...
class BSTIterator {
  ...
  //  Runtime: 14 ms, faster than 99.26% of Java online submissions for Binary Search Tree Iterator.
  //  Memory Usage: 42.4 MB, less than 96.09% of Java online submissions for Binary Search Tree Iterator.
